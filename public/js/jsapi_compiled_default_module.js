...
function gvjs_0e(a) {
    ...
    if ("undefined" !== typeof Set && a instanceof Set)
        return new Set(a);
    var b = Array.isArray(a) ? [] : typeof ArrayBuffer !== gvjs_d || typeof ArrayBuffer.isView !== gvjs_d || !ArrayBuffer.isView(a) || a instanceof DataView ? {} : new a.constructor(a.length),
        c;
    for (c in a)
        b[c] = gvjs_0e(a[c]);
    return b
...
function gvjs_Ug(a, b, c) {
    ...
    a: {
        if (b = a.array.length)
            if (--b,
                d = a.array[b], !(null === d || typeof d != gvjs_h || Array.isArray(d) || gvjs_Og && d instanceof Uint8Array)) {
                a.tK = b - a.qG;
                a.Kl = d;
                break a
            }
...
gvjs_.delete = function(a) {
    return gvjs_cj(this.qa, a) ? (delete this.qa[a],
        this.cu(this.size - 1),
        this.pM++,
        this.ad.length > 2 * this.size && gvjs_bj(this), !0) : !1
};
