            ...
            this.Zn = this.Zn.filter(function(e) {
                ...
                if (d >= e.end || e.animation.MG())
                    return e.shape.style(e.animation.lva, e.animation.iya),
                        e.animation.fireEvent(gvjs_up, [e.shape, e.animation]), !1;
...
gvjs_mS.prototype.position = function(a, b) {
    ...
    for (e = a.length; d < e; d++)
        if (c = a[d], !b && d === e - 1 || gvjs_Ria(this, c))
...
gvjs_sS.prototype.define = function(a) {
    ...
    gvjs_u(a, function(c, d) {
        ...
        e = c.subtitle;
        if (null != c.title || e) {
            var f = gvjs_cS(new gvjs_hS(c.title), this.gya).setStyle(gvjs_5c, c.eya),
                g;
...
function gvjs_SS(a) {
    ...
    null != b && (b = (c = typeof b === gvjs_g) ? b : a.scale.scale(b), !c && a.scale.isDiscrete() && (b += .5),
...
gvjs_1S.prototype.draw = function(a, b, c) {
    if (this.Qm) {
        ...
        for (g = this.sm.length; d < g; d++)
            if (m = this.xg[d], !(this.Gc > this.sm[d].v) && m.label) {
                h = b;
                e = this.vh[d];
                f = this.xp + 10;
