...
class Site extends Controller
{
    ...
    public function deleteSite($site_id)
    {
        ...
        Sites::find($site_id)->delete();

        // Remove the site and its equips from equips_names table
        EquipsDetail::where('site_name', $site->site_name)->delete();

        // Remove the site and its pins from equips_details table
        EquipsNames::where('site_name', $site->site_name)->delete();
