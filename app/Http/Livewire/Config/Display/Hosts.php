    ...
    { 
        ...
        if ($site_name == "All") {
            return DB::table('nagios_hosts')
                ...
                ->select('nagios_hosts.host_id','nagios_hosts.host_object_id','nagios_hosts.display_name','nagios_hosts.address','nagios_hoststatus.current_state','nagios_hoststatus.output','nagios_hosts.retry_interval','nagios_hoststatus.max_check_attempts','nagios_hoststatus.has_been_checked','nagios_hoststatus.notifications_enabled')
