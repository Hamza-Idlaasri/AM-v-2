...
<div class="container my-3 w-50">
    ...
    <form action="{{ route('save-equip-edits', $equip[0]->service_object_id) }}" method="get">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="text" name="equipName" class="form-control @error('equipName') border-danger @enderror" id="equip_name" value="{{ $equip[0]->display_name }}" pattern="[a-zA-Z][a-zA-Z0-9-_+ ]{2,20}" title="Service name must be between 2 & 20 charcarters in length and containes only letters, numbers, and these symbols -_+">
                @error('equipName')
