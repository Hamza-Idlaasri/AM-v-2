...
<div class="container my-3 w-50 pt-2 pb-4">
    ...
    <form action="{{ route('save-pin-edits', $equip->service_object_id) }}" method="get">
        ...
        <div class="card">
            ...
            <div class="card-body">
                {{-- pin Name --}}
                <label for="pin_name"><b>Pin Description : {{--<span class="text-danger">*</span>--}}</b></label>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <input  type="number" min="5" max="10000" name="check_interval" class="form-control p-unity @error('check_interval') border-danger @enderror" id="CheckInterval" value="{{ $equip->check_interval }}">
                ...
                <div class="d-flex">
                    <input  type="number" min="5" max="10000" name="retry_interval" class="form-control p-unity @error('retry_interval') border-danger @enderror" id="retryInterval" value="{{ $equip->retry_interval }}">
                    <span class="unity">sec</span>
                </div>
