...
<div class="container p-4 bg-white rounded shadow mx-auto my-4 w-50">
    ...
    <form action="{{ route('createSG') }}" method="get">
        ...
        <input type="text" name="servicegroup_name" class="form-control @error('servicegroup_name') border-danger @enderror" id="hg_name" value="{{ old('servicegroup_name') }}" pattern="[a-zA-Z][a-zA-Z0-9-_+ ]{2,200}" title="ServiceGroup name must be between 2 & 200 charcarters in length and containes only letters, numbers, and these symbols -_+">
